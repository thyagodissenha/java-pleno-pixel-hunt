...
export function NeonHud(props: HudProps) {
  const {
    status,
    hp,
    score,
  ...
  useEffect(() => {
    qwenStateRef.current = {
      jdk: Number(upgrade.replace("JDK ", "")) || 8,
      onda: wave,
      resets: resetCount,
      hp,
      hpMax: resolveCharacter(selectedCharacterId).maxHp,
      rajada: burstStaminaPct,
      poder: abilityCooldownPct,
      score,
      hurtTimer: damageFlash / 60,
    };
    qwenFooterStateRef.current = {
      buildInstavel: bossEncountered,
      bossNome: boss,
      bossProgress: bossKillsCount,
      bossTotal: bossKillTargetCount,
      faseNome: biome,
      users: enemyCount,
      sprintDay: wave,
      incident: bossIncident,
    };
  }, [
    upgrade,
    wave,
  ...
  return (
    <main className="game-shell">
      ...
      <Script src="/qwen-hud-lib.js" strategy="afterInteractive" />
      <Script src="/qwen-footer-lib.js" strategy="afterInteractive" />
